...
- Directory names, city, county and coordinates come from the DPI 2026-27 public school GIS layer (current September 4, 2026); the state outline is the shoreline-clipped US Census cartographic boundary. The directory is newer than the 2024-25 assessment snapshot, so schools closed before 2026-27 can be list-only.
